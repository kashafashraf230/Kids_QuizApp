...
public class MyViewAdapter extends ArrayAdapter<Question> {
    ...
    if(student.status.equals("Correct")){
        layout.setBackgroundColor(ContextCompat.getColor(getContext(), R.color.purple_200));
        textViewStatus.setTextColor(ContextCompat.getColor(getContext(), R.color.purple_200));
    }
    else{
        layout.setBackgroundColor(ContextCompat.getColor(getContext(), R.color.purple_200));
        textViewStatus.setTextColor(ContextCompat.getColor(getContext(), R.color.purple_200));
